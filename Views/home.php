...
<body class="animsition">
	...
	<header>
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="Nuevas Ofertas">
								<a href="#">Categorias</a>
							</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="<?= media();?>/tienda/images/icons/logot.png" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="#" class="label1 rs1" data-label1="NUEVAS OFERTAS">Categorias</a>
				</li>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<?= media();?>/tienda/images/ram_Ddr4.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<?= media();?>/tienda/images/corsair_2666.jpg" alt="IMG">
						</div>

						<div class="header-cart-item-txt p-t-8">
							<a href="#" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
								Memoria RAM Corsarir 2666
							</a>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(<?= media();?>/tienda/images/slideps5.jpg);">
				...
				<div class="item-slick1" style="background-image: url(<?= media();?>/tienda/images/slidenin.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(<?= media();?>/tienda/images/slidepc.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="<?= media();?>/tienda/images/pcs.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?= media();?>/tienda/images/consolas.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?= media();?>/tienda/images/componentes.jpg" alt="IMG-BANNER">
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".pcs">
						Pcs
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".consolas">
						Consolas
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".componentes">
						Componentes
					</button>
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item pcs">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro1.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item pcs">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro2.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item consolas">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro3.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componentes">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro4.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componentes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro5.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item consolas">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro6.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componentes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro7.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componentes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro8.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item consolas">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro9.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componentes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro10.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item extras">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro11.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componentes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= media();?>/tienda/images/pro12.png" alt="IMG-PRODUCT">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						¿Alguna duda? Ubicanos en 4598 M54, 379 Sin Numero St, Lima, o llamanos al (+1) 96 716 6879
					</p>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="<?= media();?>/tienda/images/prod1.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= media();?>/tienda/images/prod1.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= media();?>/tienda/images/prod1.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="<?= media();?>/tienda/images/prod2.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= media();?>/tienda/images/prod2.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= media();?>/tienda/images/prod2.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="<?= media();?>/tienda/images/prod3.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= media();?>/tienda/images/prod3.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= media();?>/tienda/images/prod3.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2" name="time">
												...
												<option>35cm x 29cm</option>
												<option>40cm x 31cm</option>
												<option>39cm x 35cm</option>
												<option>45cm x 38cm</option>
											</select>
